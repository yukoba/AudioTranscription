# Windows音声文字起こしアプリ
Google の Gemini 3 Flash を使用して音声認識を行い、「えっと」などの言い淀みを除去して、アクティブなウィンドウに認識結果を入力します。Gemini が調整するので、単純な音声認識ではなく、文章がきれいになります。Gemini API料金は約0.3円/分です。
